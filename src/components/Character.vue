<template>
  <div class="fluid">
    <div class="row justify-content-center">
        <button @click="router.back()" class="col-4 mb-4 btn btn-secondary">Go Back</button>
      <div class="col-12">
        <div class="card">
          <img class="img-char" width="600" height="600" :src="id.thumbnail.path + '/portrait_xlarge.jpg'" />
...
export default {
  setup() {
    ...
    onMounted(() => {
        ...
        const result = lists.value.filter(list => {
            return list.id == route.params.id
        })

        id.value = result[0]

        console.log('final',id.value);
